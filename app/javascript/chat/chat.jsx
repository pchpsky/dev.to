            ...
            <div className="chat__channeltypefilter">
              <button
                ...
                className={`chat__channeltypefilterbutton chat__channeltypefilterbutton--${
                  state.channelTypeFilter === 'all' ? 'active' : 'inactive'
                }`}
                type="button"
              >
                all
              ...
              <button
                ...
                onClick={this.triggerChannelTypeFilter}
                className={`chat__channeltypefilterbutton chat__channeltypefilterbutton--${
                  state.channelTypeFilter === 'direct' ? 'active' : 'inactive'
                }`}
                type="button"
              >
                direct
              ...
              <button
                ...
                onClick={this.triggerChannelTypeFilter}
                className={`chat__channeltypefilterbutton chat__channeltypefilterbutton--${
                  state.channelTypeFilter === 'invite_only'
                    ? 'active'
                    : 'inactive'
                }`}
                type="button"
  ...
  render() {
    ...
    if (currentChannel) {
      ...
      if (currentChannel.channel_type === 'direct') {
        ...
        channelHeaderInner = (
          <a
            ...
            onClick={this.triggerActiveContent}
            data-content={`chat_channels/${state.activeChannelId}`}
          >
      ...
      if (
        ...
        state.activeContent[state.activeChannelId].type_of
      ) {
        channelConfigImage = '';
      }
      channelHeader = (
